package com.xparsing.weixin.utils;
...
public class MysqlGenerator {
   private static String packageName="account_service";    //文件路径
    private static String authorName="lx";     //作者
    ...
    public static void main(String[] args) {
        ...
        AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
                ...
                new DataSourceConfig()
                        ...
                        .setUsername("root")
                        .setPassword("root")
                        .setUrl("jdbc:mysql://127.0.0.1:3306/bi?serverTimezone=UTC&characterEncoding=utf8&useSSL=true")
        ).setStrategy(
                // 策略配置
                new StrategyConfig()
                      ...
                      //  .setInclude(new String[] { table }) // 需要生成的表
                        ...
                        // 自定义 controller 父类
                      //  .setSuperControllerClass("com.taotao."+packageName+".controller.AbstractController")
                ...
                new PackageConfig()
                        //.setModuleName("User")
                        .setParent("com.xparsing.weixin")// 自定义包路径
